...
<div className="component-item">
  ...
  <p>
    SVG icon component with 18 available icons, predefined sizes (small: 1rem,
    medium: 1.5rem) and consistent stroke weight. Includes arrows, UI controls,
    and common interface icons.
  </p>
</div>
...
<div className="component-item">
  ...
  <p>
    A modal dialog component with overlay, built on Radix UI for accessible
    interactions.
  </p>
</div>
...
<div className="component-item">
  ...
  <p>
    A dropdown select component with searchable options, built on Radix UI with
    consistent styling.
  </p>
</div>
...
<div className="component-item">
  ...
  <p>
    A semantic label component with required field indicators, built on Radix UI
...
<div className="component-item">
  ...
  <p>
    A text input component with labels, validation states, and helper text for
  ...
  <div className="component-item">
    <h3>Loading</h3>
    <div className="component-examples" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)', padding: '24px', borderRadius: '8px', gap: '24px', alignItems: 'flex-end' }}>
      <Loading size="small" />
      <Loading size="medium" />
      <Loading size="large" />
    </div>
    <p>A bouncing and spinning box loader with animated shadow. Perfect for overlays and loading states with three size variants.</p>
  </div>
</div>
